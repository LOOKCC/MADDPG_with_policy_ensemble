...
class MADDPG:
    # modify 
    # k use for policy ensemble 
    def __init__(self, n_agents, dim_obs, dim_act, batch_size,
                 capacity, k ,episodes_before_train):
        ...
        self.k = k
        # modify
        self.memory = [ReplayMemory(capacity) for i in range(self.k)]
    ...
    def update_policy(self, k):
        ...
        for agent in range(self.n_agents):
            # modify
            transitions = self.memory[k].sample(self.batch_size)
